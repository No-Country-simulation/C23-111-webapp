        ...
        <>
          ...
          <Box className="flex flex-col items-center justify-center max-h-full mt-16 w-full px-5">
            ...
            <Typography variant="h4" sx={{ textAlign: "center", mt: "10px" }}>
              Aprueba o rechaza las recetas enviadas por los usuarios. ¡Gracias
              por mantener nuestra comunidad organizada!
            </Typography>
            <Typography variant="h4" sx={{ marginTop: "4%" }}>
              Hay <span style={{ color: "#F48E28" }}>{pendingRecipes.length}</span>{" "}
